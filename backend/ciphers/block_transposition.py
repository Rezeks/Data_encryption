    ...
    params_schema = [
        {
            ...
            "type": "text",
            "default": "КЛЮЧ",
            "hint": "Слово, определяющее перестановку (например: КЛЮЧ, ГАММА, ПОЛЕ)",
        },
        {
            "id": "permutation",
            "label": "Ключ перестановки (числа)",
            "type": "text",
            "default": "1,2,4,3",
            "hint": "Порядок позиций в блоке через запятую (генерируется из слова)",
        },
    ]
